...
const EditUser = () => {
  ...
  const updateUser = () => {
    ...
    userAllData["user_password"]!=="" && data.append("password", userAllData["user_password"]);
              ...
              <div className=" my-1 bg-white cat-child" style={{ border: "none!important" }}>
                <div className="row d-flex justify-content-between">
                  ...
                  <div className="mt-2 mt-md-4" style={{ marginLeft: "-10px" }}>
                    ...
                    <button onClick={()=>history.push(path.user_list)} className="save-btn mt-2">Cancel</button>
                  </div>
                </div>
              </div>
            </div>
