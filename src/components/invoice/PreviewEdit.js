...
const PreviewEdit = ({ print, Found, InvoiceAllData, status, FoundCustomer, mainState, invStatus }) => {
  // console.log(Found, "--------found------");
  // console.log(InvoiceAllData, "--------InvoiceAllData found------");
  console.log(mainState, "--------mainState found------");
  ...
  console.log("jdata from invoice----------------", Jdata);
