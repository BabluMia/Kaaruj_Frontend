...
import demoBulk from "./demoFiles/CustomerBulkDemo.xlsx";
...
const CustomerBulk = () => {
  ...
  const url = `${BASE_URL}/api/v1/inventory/bulk-import/customer/`;
  ...
  return (
    ...
    >
      <div className="bg-white mb-3">
        ...
        >
          ...
          <div className="inst mb-4" style={{ color: "#828282" }}>
            <p className="my-2">
              1. Download the format and fill it with proper data.
            </p>
            <p className="my-2">
              2. You can download the example file to understand how to data
              must be filed.
            </p>
            <p className="my-2">
              3. Onece you have downloaded and filed the format it in the form
              below and submit.
            </p>
            <p className="my-2">
              4. After uploading product you need to edit them and save product
              image and choice.
            </p>
            <p className="my-2">
      ...
      <div className="bg-white">
        ...
        <div
          className="d-flex align-items-center justify-content-between side-pd"
        ...
        >
          ...
          >
            <img className="me-1 format-img" src={down} alt="" /> Download
            Format
          </Link>
        </div>
